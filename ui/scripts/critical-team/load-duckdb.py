...
DEFAULT_DATA_SOURCES_CONFIG = PROJECT_ROOT / "python" / "portal" / "app" / "config" / "data_sources.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Cityworks SQL Server. Default comes from python/portal/app/config/data_sources.json.",
    )
    parser.add_argument(
        "--database",
        default=portal_env("PORTAL_CITYWORKS_DATABASE", source_config["database"]),
        help="Cityworks SQL database. Default comes from python/portal/app/config/data_sources.json.",
    )
