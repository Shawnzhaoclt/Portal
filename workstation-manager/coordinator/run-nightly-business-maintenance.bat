...
rem Runs one safe nightly checkpoint-and-backup cycle. It does not archive data.
...
"%PYTHON_EXE%" "%RUNNER%" --task snapshot.nightly.run --portal-settings "%PORTAL_SETTINGS%"
exit /b %ERRORLEVEL%
