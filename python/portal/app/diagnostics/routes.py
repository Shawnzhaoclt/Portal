...
import pyodbc
import sqlalchemy
from portal.runtime.transport import APIRouter

from portal.app.diagnostics.environment import ENV_FILE, check_import, read_dependencies
...
@router.get("/desktop/data-sources")
def desktop_data_sources() -> dict[str, Any]:
    ...
    return {"configured": True, "sources": results}
